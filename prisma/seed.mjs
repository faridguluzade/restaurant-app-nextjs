...
export default async function main() {
  ...
  const restaurants = await client.restaurants.findMany();
  ...
  const userLaith = await client.user.create({
    data: {
      first_name: "Laith",
      last_name: "Harb",
  ...
  const userJosh = await client.user.create({
    data: {
      first_name: "Josh",
      last_name: "Allen",
  ...
  const userLebron = await client.user.create({
    data: {
      first_name: "LeBron",
      last_name: "James",
  ...
  const userCassidy = await client.user.create({
    data: {
      first_name: "Cassidy",
      last_name: "Marksom",
